...
# -*- coding: utf-8 -*-
#
# learning documentation build configuration file, created by  # noqa: E501
...
modindex_common_prefix = ["learning"]
...
html_context = {
    "display_github": True,
    "github_user": "hugl040129-rgb",
    "github_repo": "learning",
    "github_version": "main",
...
basename = "learning".replace(" ", "").replace(".", "")
